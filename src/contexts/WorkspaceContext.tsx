...
export type WorkspaceType = 'work' | 'sync' | 'insights' | 'settings' | 'openhouse' | 'calendar' | 'listingwriter' | 'commissioncoach' | 'sequences' | 'appointments' | 'objectioncoach' | 'deals' | 'openhousekiosk';
...
export function WorkspaceProvider({ children }: { children: React.ReactNode }) {
  ...
  const [activeWorkspace, setActiveWorkspace] = useState<WorkspaceType | null>(() => {
    ...
    const valid: WorkspaceType[] = ['work', 'sync', 'insights', 'settings', 'openhouse', 'calendar', 'listingwriter', 'commissioncoach', 'sequences', 'appointments', 'objectioncoach', 'deals', 'openhousekiosk'];
