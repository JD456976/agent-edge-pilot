...
export type WorkspaceType = 'work' | 'sync' | 'insights' | 'settings' | 'openhouse' | 'marketcompass';
...
export function WorkspaceProvider({ children }: { children: React.ReactNode }) {
  ...
  const [activeWorkspace, setActiveWorkspace] = useState<WorkspaceType | null>(() => {
    ...
    try {
      ...
      const valid: WorkspaceType[] = ['work', 'sync', 'insights', 'settings', 'openhouse', 'marketcompass'];
