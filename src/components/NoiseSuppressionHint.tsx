...
export const NoiseSuppressionHint = forwardRef<HTMLDivElement, Props>(
  function NoiseSuppressionHint({ reason, lastShownAt }, ref) {
    const [showDetail, setShowDetail] = useState(false);

    return (
      <div ref={ref} className="text-[10px] text-muted-foreground/60">
        <button
